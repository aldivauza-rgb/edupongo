...
const FALLBACK = {
  ...
  kepsek: [
    { icon: '📈', tag: 'Satu Dashboard, Semua Data', title: 'Pantau Sekolah Secara Real-Time', desc: 'Kehadiran siswa hari ini, progress jurnal mengajar guru, status pembayaran SPP, dan data PPDB — semua terlihat dari satu layar tanpa harus tanya ke masing-masing bagian.' },
    ...
    { icon: '🎓', tag: 'Lengkap & Terpusat', title: 'Data Siswa, Alumni & BK', desc: 'Seluruh riwayat data siswa — dari penerimaan, akademik, bimbingan konseling, hingga alumni — tersimpan rapi dan mudah diakses kapanpun.' },
  ],
  ortu: [
